...
namespace Saklib
{
    namespace Qtlib
    {
        inline QString to_QString(size_type value)          { return QString(to_String(value).c_str()); }

        inline QString to_QString(Bool value)               { return QString(to_String(value).c_str()); }
        inline QString to_QString(Int value)                { return QString(to_String(value).c_str()); }
        inline QString to_QString(Double value)             { return QString(to_String(value).c_str()); }
