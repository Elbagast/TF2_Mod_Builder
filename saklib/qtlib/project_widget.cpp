...
void Saklib::Qtlib::Project_Widget::set_element_name(ElementID elementid, String const& value)
{
...
bool Saklib::Qtlib::Project_Widget::undoable_set_element_name(ElementID elementid, String const& value)
{
