...
namespace Saklib
{
    ...
    std::ostream& serialise_Attribute_as_key_values(std::ostream& stream, Attribute const*const attribute, std::size_t indent_level = 0, std::string const& indent = std::string("  "));
