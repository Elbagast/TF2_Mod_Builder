...
namespace saklib
{
    ...
    */
    template <>
    class Command_Value<std::vector<ElementID>>
    {
    public:
        Command_Value(Project_Manager* project_manager, std::vector<ElementID> const& value) :
              mp_project_manager{project_manager},
              m_value(value)
        {
            assert(mp_project_manager);
        ...
        std::vector<ElementID>& value ()                 { return m_value; }
        std::vector<ElementID> const& cvalue() const     { return m_value; }

        operator std::vector<ElementID>& ()              { return m_value; }
        operator std::vector<ElementID> const& () const  { return m_value; }

        Project_Manager* project_manager()          { return mp_project_manager; }

    private:
        Project_Manager* mp_project_manager;
        std::vector<ElementID> m_value;
    };
    ...
    */
    ...
    private:
        Command_Value<std::vector<T>> m_old_vector;
    };
