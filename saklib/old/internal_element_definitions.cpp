...
saklib::Element_Definition saklib::internal_definition_of_Project()
{
    return Element_Definition("Project", true,
    {
        ...
        make_shared_Attribute_Definition_by_type<ElementID>("TestElement", std::vector<String>{"SingleInt"}),
        ...
        make_shared_Attribute_Definition_by_type<std::vector<ElementID>>("TestVectorElementID2", std::vector<String>{"File"}),
    });
}
...
saklib::Element_Definition saklib::internal_definition_of_Build()
{
    ...
    ad3->emplace_constraint(std::vector<String>{"Build", "SingleInt"});
