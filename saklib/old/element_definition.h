    ...
    */
    ...
    public:
        ...
        explicit Element_Definition(String const& type, bool can_be_root = false) :
            ...
            m_attribute_definitions()
        {}
        Element_Definition(String const& type, bool can_be_root, std::vector<std::shared_ptr<Attribute_Definition>> const& attribute_definitions) :
            m_element_type(type),
            m_can_be_root(can_be_root),
        ...
        std::vector<std::shared_ptr<Attribute_Definition>> const& attribute_definitions() const
        {
            return m_attribute_definitions;
        }

        template <typename T>
        void add_attribute_definition(std::unique_ptr<Attribute_Definition_Type<T>>& definition)
        {
    ...
    private:
        ...
        bool m_can_be_root;
        std::vector<std::shared_ptr<Attribute_Definition>> m_attribute_definitions;
