...
// Special 6
//============================================================
sak::Outliner_Root_Item::Outliner_Root_Item(Project* a_project):
  internal::Outliner_Root_Item_Base(),
  m_project{a_project}
{
  this->set_true_child(std::make_unique<Child_Item_Type>(this));
}
sak::Outliner_Root_Item::~Outliner_Root_Item() = default;
...
void sak::Outliner_Root_Item::do_context_menu(QAbstractItemView* a_view, Outliner_Model* a_model, QPoint const& a_position)
{
...
void sak::Outliner_Root_Item::do_double_clicked(QAbstractItemView* a_view, Outliner_Model* a_model)
{
...
//============================================================
sak::Project_Interface* sak::Outliner_Root_Item::get_project()
{
  return m_project;
}

sak::Project_Interface const* sak::Outliner_Root_Item::cget_project() const
{
  return m_project;
}

sak::Outliner_Project_Item* sak::Outliner_Root_Item::get_project_item() const
{
  return this->get_true_child();
}

sak::Outliner_Entity_Item* entity_item(int a_index) const
{
  return this->get_true_child()->entity_item(a_index);
}

sak::File_Outliner_Header_Item* sak::Outliner_Root_Item::file_header_item() const
{
  return this->get_true_child()->file_header_item();
}

sak::Texture_Outliner_Header_Item* sak::Outliner_Root_Item::texture_header_item() const
{
