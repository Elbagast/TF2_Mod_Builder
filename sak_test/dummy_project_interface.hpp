#ifndef SAK_TESTING_DUMMY_PROJECT_INTERFACE_HPP
#define SAK_TESTING_DUMMY_PROJECT_INTERFACE_HPP
...
{
  //---------------------------------------------------------------------------
  // Dummy_Member_Interface_Imp<List,LI,MI,LL,ML>
  //---------------------------------------------------------------------------
  ...
  >
  class Dummy_Member_Interface_Imp;
  ...
  class Dummy_Member_Interface_Imp<flamingo::typelist<Args...>,LI,MI,LL,ML> :
      public Dummy_Member_Interface_Imp<flamingo::typelist<Args...>,LI,MI+1>
  {
    using Inh = Dummy_Member_Interface_Imp<flamingo::typelist<Args...>,LI,MI+1>;
  ...
  public:
    ...
    // Special 6
    //============================================================
    ~Dummy_Member_Interface_Imp() override = default;
    ...
    {
      std::cout << "sak::Dummy_Member_Interface_Imp::try_get" << " " << LI << "," << MI << "," << LL << "," << ML << std::endl;
    ...
    {
      std::cout << "sak::Dummy_Member_Interface_Imp::try_set" << " " << LI << "," << MI << "," << LL << "," << ML << std::endl;
      return false;
    }
  };
  ...
  //---------------------------------------------------------------------------
  // Dummy_Member_Interface_Imp<List,LI,ML,LL,ML>
  //---------------------------------------------------------------------------
  ...
  class Dummy_Member_Interface_Imp<flamingo::typelist<Args...>,LI,ML,LL,ML> :
      public Dummy_Member_Interface_Imp<flamingo::typelist<Args...>,LI+1>
  {
  public:
    // Special 6
    //============================================================
  ...
  //---------------------------------------------------------------------------
  // Dummy_Member_Interface_Imp<List,LL,ML,LL,ML>
  //---------------------------------------------------------------------------
  ...
  class Dummy_Member_Interface_Imp<flamingo::typelist<Args...>,LL,ML,LL,ML> :
  ...
  //---------------------------------------------------------------------------
  // Dummy_Section_Interface_Imp<List,LI,LL>
  //---------------------------------------------------------------------------
  // Declaration and default arguments for the template class that builds the
  // template chain.
  template
  ...
  >
  class Dummy_Section_Interface_Imp;

  //------------------------------------------------------------------------------------------------------------------------------------------------------

  //---------------------------------------------------------------------------
  // Dummy_Section_Interface_Imp<List,LI,LS>
  //---------------------------------------------------------------------------
  // For a type in the list, build its interface.

  template <std::size_t LI, std::size_t LS, typename...Args>
  class Dummy_Section_Interface_Imp<flamingo::typelist<Args...>,LI,LS> :
      public Dummy_Section_Interface_Imp<flamingo::typelist<Args...>,LI+1>
  {
    using Inh = Dummy_Section_Interface_Imp<flamingo::typelist<Args...>,LI+1>;
    using Type = flamingo::typelist_at_t<flamingo::typelist<Args...>,LI>;
    using Data_Type = Data<Type>;
    using ID_Type = ID<Type>;
  ...
  public:
    ...
    // Special 6
    //============================================================
    ~Dummy_Section_Interface_Imp() override = default;
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::is_empty" << " " << LI << "," << LS << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::count" << " " << LI << "," << LS << std::endl;
      return std::size_t{};
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::has" << " " << LI << "," << LS << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::has_name" << " " << LI << "," << LS << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::get_at" << " " << LI << "," << LS << std::endl;
      return ID_Type{};
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::get_named" << " " << LI << "," << LS << std::endl;
      return ID_Type{};
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::get_ids" << " " << LI << "," << LS << std::endl;
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::get_names" << " " << LI << "," << LS << std::endl;
    ...
    std::size_t get_index(ID_Type const& a_id) const override
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::get_index" << " " << LI << "," << LS << std::endl;
      return std::size_t{};
    }
    ...
    QString get_name(ID_Type const& a_id) const override
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::get_name" << " " << LI << "," << LS << std::endl;
      return QString{};
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::try_set_name" << " " << LI << "," << LS << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::add_default" << " " << LI << "," << LS << std::endl;
      return ID_Type{};
    }
    ...
    //{
     // std::cout << "sak::Dummy_Section_Interface_Imp::try_add" << " " << LI << "," << LS << std::endl;
    //  return false;
    //}
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::try_remove" << " " << LI << "," << LS << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::try_request_editor" << " " << LI << "," << LS << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Section_Interface_Imp::try_request_outliner" << " " << LI << "," << LS << std::endl;
      return false;
    }
  };
  ...
  //---------------------------------------------------------------------------
  // Dummy_Section_Interface_Imp<List,LS,LS>
  //---------------------------------------------------------------------------
  // At the end of the list start building the member interfaces.
  template <std::size_t LS, typename...Args>
  class Dummy_Section_Interface_Imp<flamingo::typelist<Args...>,LS,LS> :
      public Dummy_Member_Interface_Imp<flamingo::typelist<Args...>>
  {
  public:
    // Special 6
    //============================================================
  ...
  //---------------------------------------------------------------------------
  // Dummy_Project_Interface_Imp<List,LS,LS>
  //---------------------------------------------------------------------------
  ...
  class Dummy_Project_Interface_Imp :
      public Dummy_Section_Interface_Imp<flamingo::typelist<T,Args...>>
  {
    using Inh = Dummy_Section_Interface_Imp<flamingo::typelist<T,Args...>>;
  ...
  public:
    ...
    // Special 6
    //============================================================
    ~Dummy_Project_Interface_Imp() override = default;

    // Virtuals
    //============================================================
    void save() const override
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::save" << std::endl;
    }

    void load() override
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::load" << std::endl;
    }

    // Data that is fixed on contruction.
    QString name() const override
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::name" << std::endl;
      return QString{};
    }

    QString location() const override
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::location" << std::endl;
      return QString{};
    }

    QString filepath() const override
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::filepath" << std::endl;
      return QString{};
    }
    ...
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::can_undo" << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::can_redo" << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::undo_count" << std::endl;
      return std::size_t{0};
    }
    ...
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::redo_count" << std::endl;
      return std::size_t{0};
    }
    ...
    bool undo() override
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::undo" << std::endl;
      return false;
    }
    ...
    bool redo() override
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::redo" << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::clear_history" << std::endl;
    }

    // Does this name appear in the data?
    bool has_name(QString const&) const override
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::has_name" << std::endl;
      return false;
    }
    ...
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::get_all_names" << std::endl;
      return std::vector<QString>{};
    }
    ...
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::fix_name" << std::endl;
    }
    ...
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::add_signalbox" << std::endl;
    }
    ...
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::remove_signalbox" << std::endl;
    }

    // Clear all the signalboxes so that nothing relies on changes to this.
    void clear_signalboxes() override
    {
      std::cout << "sak::Dummy_Project_Interface_Imp::clear_signalboxes" << std::endl;
    }
...
#endif // SAK_TESTING_DUMMY_PROJECT_INTERFACE_HPP
