...
QString qtlib::To_QString<QString>::operator()(QString const& a_value) const
{
  return a_value;
}
...
bool qtlib::From_QString<bool>::operator()(QString const& a_string) const
{
  return generic::From_Std_String<bool>()(a_string.toStdString());
}

std::int8_t qtlib::From_QString<std::int8_t>::operator()(QString const& a_string) const
{
  return static_cast<std::int8_t>(a_string.toLongLong());
}

std::int16_t qtlib::From_QString<std::int16_t>::operator()(QString const& a_string) const
{
  return static_cast<std::int16_t>(a_string.toLongLong());
}

std::int32_t qtlib::From_QString<std::int32_t>::operator()(QString const& a_string) const
{
  return static_cast<std::int32_t>(a_string.toLongLong());
}

std::int64_t qtlib::From_QString<std::int64_t>::operator()(QString const& a_string) const
{
  return static_cast<std::int64_t>(a_string.toLongLong());
}

std::uint8_t qtlib::From_QString<std::uint8_t>::operator()(QString const& a_string) const
{
  return static_cast<std::uint8_t>(a_string.toULongLong());
}

std::uint16_t qtlib::From_QString<std::uint16_t>::operator()(QString const& a_string) const
{
  return static_cast<std::uint16_t>(a_string.toULongLong());
}

std::uint32_t qtlib::From_QString<std::uint32_t>::operator()(QString const& a_string) const
{
  return static_cast<std::uint32_t>(a_string.toULongLong());
}

std::uint64_t qtlib::From_QString<std::uint64_t>::operator()(QString const& a_string) const
{
  return static_cast<std::uint64_t>(a_string.toULongLong());
}

float qtlib::From_QString<float>::operator()(QString const& a_string) const
{
  return a_string.toFloat();
}

double qtlib::From_QString<double>::operator()(QString const& a_string) const
{
  return a_string.toDouble();
}

long double qtlib::From_QString<long double>::operator()(QString const& a_string) const
{
  // not proper...
  return static_cast<long double>(a_string.toDouble());
}

std::string qtlib::From_QString<std::string>::operator()(QString const& a_string) const
{
  return a_string.toStdString();
}

std::u16string qtlib::From_QString<std::u16string>::operator()(QString const& a_string) const
{
  return a_string.toStdU16String();
}

std::u32string qtlib::From_QString<std::u32string>::operator()(QString const& a_string) const
{
  return a_string.toStdU32String();
}

std::wstring qtlib::From_QString<std::wstring>::operator()(QString const& a_string) const
{
  return a_string.toStdWString();
}

QString qtlib::From_QString<QString>::operator()(QString const& a_string) const
{
  return a_string;
}
