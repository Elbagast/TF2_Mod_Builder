#include "outliner_orphanded_item.h"
...
// Special 6
//============================================================
qtlib::outliner::abstract::Orphaned_Item::~Orphaned_Item() = default;
...
bool qtlib::outliner::abstract::Orphaned_Item::has_parent() const
{
    return this->abstract::Item::has_parent();
}

// Get the item that is the parent of this
qtlib::outliner::abstract::Orphaned_Item::item_type* qtlib::outliner::abstract::Orphaned_Item::get_parent() const
{
    return this->abstract::Item::get_parent();
}

// Get the item at the root of the structure
qtlib::outliner::abstract::Orphaned_Item::item_type* qtlib::outliner::abstract::Orphaned_Item::get_root() const
{
...
// then -1 is returned.
int qtlib::outliner::abstract::Orphaned_Item::index_in_parent() const
{
...
bool qtlib::outliner::abstract::Orphaned_Item::has_children() const
{
    return this->abstract::Item::has_children();
}

// The number of child items this item has
int qtlib::outliner::abstract::Orphaned_Item::get_child_count() const
{
...
bool qtlib::outliner::abstract::Orphaned_Item::has_child_at(int a_index) const
{
    return this->abstract::Item::has_child_at(a_index);
}

// Get the child at a given row, return nullptr if there is no child at row
qtlib::outliner::abstract::Orphaned_Item::item_type* qtlib::outliner::abstract::Orphaned_Item::get_child_at(int a_index) const
{
...
QVariant qtlib::outliner::abstract::Orphaned_Item::get_data(int a_role) const
{
    return this->abstract::Item::get_data(a_role);
}

// Set the data in item with the given value
void qtlib::outliner::abstract::Orphaned_Item::set_data(QVariant const& a_value)
{
...
QWidget* qtlib::outliner::abstract::Orphaned_Item::get_editor(QWidget* a_parent)
{
    return this->abstract::Item::get_editor(a_parent);
}

// Set the data in the editor to the value in the item
void qtlib::outliner::abstract::Orphaned_Item::set_editor_data(QWidget* a_editor)
{
    return this->abstract::Item::set_editor_data(a_editor);
}

// Get the data in the editor and return it
QVariant qtlib::outliner::abstract::Orphaned_Item::get_editor_data(QWidget* a_editor)
{
...
Qt::ItemFlags qtlib::outliner::abstract::Orphaned_Item::get_flags() const
{
...
void qtlib::outliner::abstract::Orphaned_Item::do_custom_context_menu(QAbstractItemView* a_view, model_type* a_model, QPoint const& a_point)
{
