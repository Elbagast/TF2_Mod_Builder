...
namespace sak
{
    ...
    namespace outliner
    {
        ...
        public:
            ...
            File_HPPeader_Item* file_header_item() const;
        ...
        class Project_Item :
                public qtlib::outliner::Readonly_Multitrunk_item<Root_Item, File_HPPeader_Item>
        {
            using inherited_type = qtlib::outliner::Readonly_Multitrunk_item<Root_Item, File_HPPeader_Item>;
        public:
        ...
        public:
            // Special 6
            //============================================================
            explicit File_HPPeader_Item(parent_type* a_parent, bool a_read_files = true);
            ~File_HPPeader_Item() override;
        ...
        class File_Item :
                public qtlib::outliner::Leaf_Item<File_HPPeader_Item>
        {
            using inherited_type = qtlib::outliner::Leaf_Item<File_HPPeader_Item>;
        public:
            // Special 6
            //============================================================
...
#endif // PROJECT_OUTLINER_ITEMS_HPP
