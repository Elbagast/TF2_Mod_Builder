...
sak::gui::Validating_Line_Edit::Validating_Line_Edit(QWidget* a_parent):
  QLineEdit(a_parent),
...
sak::gui::Validating_Line_Edit::Validating_Line_Edit(QValidator* a_validator, Abstract_State_Changer<QLineEdit>* a_state_changer, QWidget* a_parent):
...
sak::gui::Validating_Line_Edit::~Validating_Line_Edit() = default;

// Interface
//============================================================
// Access the current validator. Returns nullptr if there isn't one.
QValidator* sak::gui::Validating_Line_Edit::get_validator() const
{
  return m_validator;
}
...
void sak::gui::Validating_Line_Edit::set_validator(QValidator* a_validator)
{
...
sak::gui::Abstract_State_Changer<QLineEdit>* sak::gui::Validating_Line_Edit::get_state_changer() const
{
...
void sak::gui::Validating_Line_Edit::set_state_changer(Abstract_State_Changer<QLineEdit>* a_state_changer)
{
...
bool sak::gui::Validating_Line_Edit::is_valid() const
{
  return m_validity_state;
}

// QLineEdit::textChanged is linked to this slot to make the local state changes.
void sak::gui::Validating_Line_Edit::update_state(QString const& a_new_text)
{
