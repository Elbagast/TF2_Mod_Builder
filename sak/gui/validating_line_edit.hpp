#ifndef VALIDATING_LINE_EDIT_HPP
#define VALIDATING_LINE_EDIT_HPP
...
namespace sak
{
  namespace gui
  {
    ...
    public:
      ...
      Validating_Line_Edit(QValidator* a_validator, Abstract_State_Changer<QLineEdit>* a_state_changer, QWidget* a_parent = nullptr);
      ...
      Abstract_State_Changer<QLineEdit>* get_state_changer() const;
      ...
      void set_state_changer(Abstract_State_Changer<QLineEdit>* a_state_changer);
    ...
    private:
      ...
      Abstract_State_Changer<QLineEdit>* m_state_changer;
    };
  }
}


#endif // VALIDATING_LINE_EDIT_HPP
