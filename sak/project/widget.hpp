#ifndef SAK_PROJECT_WIDGET_H
#define SAK_PROJECT_WIDGET_H
  ...
  namespace project
  {
    ...
    */
    ...
    public:
      ...
      explicit widget(std::unique_ptr<object>&& a_project, QWidget* a_parent = nullptr);
      ~widget() override;
