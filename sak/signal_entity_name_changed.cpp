...
// Special 6
//============================================================
sak::Signal_Entity_Name_Changed::Signal_Entity_Name_Changed(Signal_Source a_source, Entity_ID a_id, String const& a_old_name, String const& a_new_name) :
...
// Interface
//============================================================
sak::String const& sak::Signal_Entity_Name_Changed::old_name() const noexcept
{
  return m_old_name;
}

sak::String const& sak::Signal_Entity_Name_Changed::new_name() const noexcept
{
  return m_new_name;
}
