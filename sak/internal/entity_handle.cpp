...
sak::Entity_Handle::Entity_Handle(Entity&& a_entity):
  Entity_Handle{std::make_shared<Entity>(std::move(a_entity))}
{
}

sak::Entity_Handle::Entity_Handle(std::shared_ptr<Entity>&& a_entity):
  m_data{std::move(a_entity)}
{
